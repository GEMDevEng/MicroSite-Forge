    ...
    return (
      <Card>
        <CardContent className="p-6 text-center">
          ...
          <h3 className="mb-2 text-lg font-medium text-gray-900">No campaigns found</h3>
          <p className="text-gray-500">
            Create your first campaign to get started with lead nurturing.
          </p>
        </CardContent>
      </Card>
    )
          ...
          <CardHeader className="pb-3">
            <div className="flex items-start justify-between">
              <div className="flex items-start space-x-3">
                <div className="rounded-lg bg-gray-100 p-2">{getTypeIcon(campaign.type)}</div>
                  ...
                  <div className="flex items-center space-x-2">
                    ...
                    <div>
                      ...
                      <p className="text-xs text-gray-500">
                        {campaign.metrics.opened}/{campaign.metrics.sent} opens
                      </p>
                    </div>
                  </div>
                  ...
                  <div className="flex items-center space-x-2">
                    ...
                    <div>
                      <p className="text-sm font-medium">
                        {campaign.metrics.clickRate}% click rate
                      </p>
